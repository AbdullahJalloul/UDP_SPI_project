...
typedef struct
{
	__IO unsigned	dummy0			:1;	// SPI0 ?
	__IO unsigned	dummy1			:1;
	__IO unsigned	dummy2			:1;	// SPI0 ?
...
typedef struct
{
	union
	{
		__IO u32 			gpio_mux_cfg;		// 0x60000800
		__IO gpio_mux_cfg_t	gpio_mux_cfg_bits;
	};
	union
	{
		__IO u32			gpio_mux_mtdi_u;		// 0x60000804
		__IO u32			gpio12_mux;
		__IO gpio_mux_t		gpio12_mux_bits;
	};
	union
	{
		__IO u32			gpio_mux_mtck_u;		// 0x60000808
		__IO u32			gpio13_mux;
		__IO gpio_mux_t		gpio13_mux_bits;
	};
	union
	{
		__IO u32			gpio_mux_mtms_u;		// 0x6000080C
		__IO u32			gpio14_mux;
		__IO gpio_mux_t		gpio14_mux_bits;
	};
	union
	{
		__IO u32			gpio_mux_mtdo_u;		// 0x60000810
		__IO u32			gpio15_mux;
		__IO gpio_mux_t		gpio15_mux_bits;
	};
	union
	{
		__IO u32			gpio_mux_u0rxd_u;		// 0x60000814
		__IO u32			gpio3_mux;
