...
typedef struct
{
	...
	__IO u8	miso_delay_mode		:2;	// SPI_CTRL2_CLK_HDIV4 (BIT(15)) Уменьшает длительность "1" на CLK в 4 раза
	__IO u8	cl_out_high_mode	:4;	// SPI_CTRL2_CLK_HDIV2 (BIT(12)) Уменьшает длительность "1" на CLK в 2 раза
