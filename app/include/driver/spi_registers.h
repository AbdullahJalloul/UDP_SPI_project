...
typedef struct
{
	...
	__IO u8		cs_hold_delay		:4;	// кол-во тактов SPI-CLK задержки до выставления прерывания и готовности
} SPI_ctrl1_t;
...
typedef struct
{
	...
	__IO u8	cl_out_high_mode	:4;	// SPI_CTRL2_CLK_HDIV2 BIT12 Уменьшает длительность "1" на CLK в 2 раза
	__IO u8	miso_delay_mode		:2;	// SPI_CTRL2_CLK_HDIV4 BIT15 Уменьшает длительность "1" на CLK в 4 раза
...
typedef struct
{
	...
	__IO unsigned	mosi_miso	:1; // сигнал MISO выводится на MOSI
	...
	__IO unsigned	clk_inv		:1;	// инверсия сигнала CLK
...
typedef struct
{
	__IO u8		int_priority	:2;	// 1-высокий приоритет 3-низкий при overlap SPI
	__IO u32	dummy1			:30;
} SPI_ext3_t;
...
#define SPI_CTRL2_CLK_HDIV2					BIT12 // Уменьшает длительность "1" на CLK в 2 раза
#define SPI_CTRL2_CLK_HDIV4					BIT15 // Уменьшает длительность "1" на CLK в 4 раза
...
// SPI_PIN:
//#define SPI_PIN_CS_0						BIT31	// CS = "0"
#define SPI_PIN_CS0							BIT30	// CS = "0"
#define SPI_PIN_CLK_INV						BIT29	// инверсия сигнала CLK
//#define SPI_PIN_CLK1_CS0					BIT19	// CS = "0", CLK = "1"
#define SPI_PIN_MOSI_MISO					BIT16	// сигнал MISO выводится на MOSI
#define SPI_PIN_CS_CLK						BIT11	// сигнал на CS = CLK
#define SPI_PIN_CS_INV						BIT6	// инверсия сигнала CS
//#define SPI_PIN_CLK_DIS					BIT5	// Выход CLK = "0"
