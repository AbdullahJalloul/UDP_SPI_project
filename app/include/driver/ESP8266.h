...
#define RTC_MEM_BASE	rtc_mem_	// 0x60001100   // Size: 768 bytes, 192 dword registers, user data ��������� 512 ����
...
#define FLASH_CACHE_MAX_SIZE	0x100000 // ������ "����������" ������� Flash
#define FLASH_SYSCONST_ADR 0x0007C000

/* interrupt related */
#define ETS_SLC_INUM		1
#define ETS_SPI_INUM        2
#define ETS_RTC_INUM        3 // ��. ets_rtc_int_register()
