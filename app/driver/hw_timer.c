...
{
	TIMER->frc1_load = US_TO_RTC_TIMER_TICKS(val);
...
void ICACHE_FLASH_ATTR hw_timer_init (FRC1_TIMER_SOURCE_TYPE source_type, u8 req)
{
	if (req == 1)
	{
		TIMER->frc1_control = FRC1_AUTO_LOAD | DIVDED_BY_16 | FRC1_ENABLE_TIMER | TM_EDGE_INT;
//		RTC_REG_WRITE(FRC1_CTRL_ADDRESS,
//		        FRC1_AUTO_LOAD | DIVDED_BY_16 | FRC1_ENABLE_TIMER | TM_EDGE_INT);
	}
	else
	{
		TIMER->frc1_control = DIVDED_BY_16 | FRC1_ENABLE_TIMER | TM_EDGE_INT;
//		RTC_REG_WRITE(FRC1_CTRL_ADDRESS,
